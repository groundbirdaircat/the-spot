...
var player = {
    init(obj){
        ...
        this.playerID = uID.generate()

        console.log('player created', this)

        map.tiles[this.tileX][this.tileY].addPlayerToTile(this)
    ...
    move(x, y){
        ...
        if (
            ...
            map.tiles[this.tileX][this.tileY].removePlayerFromTile(this)
...
var map = {
    ...
    setMapID(){
        if (this.mapID) uID.remove(this.mapID)
        this.mapID = uID.generate()
    },
    setAllHousesWS(){
        // turn all houses
